...
public:
    ...
    static bool authServiceNotification(LSHandle *sh, const char *serviceName, bool connected, void *ctx);
...
private:
    ...
    static bool cbDeviceLockModeChanged(LSHandle* handle, LSMessage* message, void* ctx);
