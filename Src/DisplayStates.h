...
class DisplayStateBase {
    public:
        // States own Timer allocations and are never copied.
        DisplayStateBase(const DisplayStateBase&) = delete;
        DisplayStateBase& operator=(const DisplayStateBase&) = delete;
